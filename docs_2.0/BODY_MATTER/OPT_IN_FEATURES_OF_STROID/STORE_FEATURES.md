...
If a store asks for persistence, sync, or devtools without importing the corresponding module, Stroid warns and does not silently pretend that feature exists.

That is the right behavior.

Silent failure creates superstition.
Explicit warning creates understanding.
...
- Missing feature imports warn instead of silently becoming undefined behavior.
...
3. Why is an explicit missing-feature warning better than a silent no-op?
