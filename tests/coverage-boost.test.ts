/**
 * @module tests/coverage-boost
 *
 * LAYER: Tests
 * OWNS:  Targeted coverage gaps across small runtime modules.
 *
...
import { createListStore, createEntityStore } from "../src/helpers.js";
import { store, namespace } from "../src/store-name.js";
...
import { setRegistryScope, getStoreRegistry, resetAllStoreRegistriesForTests, clearRegistryScopeOverrideForTests } from "../src/store-registry.js";
import { createStoreForRequest } from "../src/server.js";
import { subscribeWithSelector, createSelector } from "../src/selectors.js";
import { notify, subscribeStore } from "../src/store-notify.js";
...
import { registerComputed, unregisterComputed, getTopoOrderedComputeds, getFullComputedGraph, getComputedDepsFor } from "../src/computed-graph.js";
import { registerStoreFeature, resetRegisteredStoreFeaturesForTests, setFeatureRegistrationHook } from "../src/feature-registry.js";
import { runFeatureDeleteHooks, resolveFeatureAvailability } from "../src/store-lifecycle/hooks.js";
import { featureRuntimes, initializeRegisteredFeatureRuntimes } from "../src/store-lifecycle/registry.js";
...
import { benchmarkStoreSet } from "../src/testing.js";
...
test("resetAsyncRegistry cleans handlers and timers", () => {
  ...
  registry.cleanupSubs["one"] = () => { calls += 1; };
  registry.storeCleanupFns["one"] = new Set([() => { calls += 1; }]);
